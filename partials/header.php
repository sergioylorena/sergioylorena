...
// fetchear usuario actual de la DB
...
<body>
    <nav>
        <div class="container nav__container">
            <a href="<?= ROOT_URL ?>" class="nav__logo">SERGIO Y LORE</a>
            <ul class="nav__items">
                <li><a href="<?= ROOT_URL ?>blog.php">Publicaciones</a></li>
                <li><a href="<?= ROOT_URL ?>about.php">Historia</a></li>
                ...
                <?php if (isset($_SESSION['user-id'])) : ?>
                    <li class="nav__profile">
                        ...
                        <ul>
                            <li><a href="<?= ROOT_URL ?>admin/index.php">Panel Admin</a></li>
